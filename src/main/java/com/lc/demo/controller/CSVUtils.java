...
//        创建文件
        //String pathname = "C:" + File.separator + "usr" + File.separator + "da-file";
...
//        写入内容
    ...
    public static boolean downloadByStream(InputStream  fileInputStream,HttpServletResponse response){
        BufferedInputStream bufferedInputStream = null;
        OutputStream os = null;
        try {
            bufferedInputStream = new BufferedInputStream(fileInputStream);
...
//              每行的内容
    ...
    public static List<List<String>> readCSVByStream(InputStream fileInputStream, int colNum) {
        BufferedReader bufferedReader = null;
        InputStreamReader inputStreamReader = null;
